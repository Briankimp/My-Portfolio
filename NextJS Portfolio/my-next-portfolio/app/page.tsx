  ...
  return (
    <main>
      <div className=" flex justify-between">
        <div className="w-1/2 ">
          <div className=" items-center md:w-1/2 ">
            ...
            <div className=" text-wrap text-sm w-80 p-3">
              <p>
                ...
                learning new things along the way. I really hope to finish this
                site{" "}
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-5 ">
            ...
            <Link href="/github" className="">
              {/* <Button className=" items-center border  rounded-full  border-accent text-accent hover:bg-accent-hover hover:text-primary "> */}
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20 "
            ...
            <Link href="/twitter">
              <Button className=" border rounded-full px-5  p-2 border-accent hover: fill-accent-hover text-accent hover:bg-accent-hover hover:text-primary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
            ...
            <Link href="/whastapp">
              <Button className=" border rounded-full px-5 fill-accent  p-2 border-accent text-accent hover:bg-accent-hover hover:text-primary  ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  id="IconChangeColor"
        ...
        <div className="bg-accent w-1/2  items-center rounded-full">
