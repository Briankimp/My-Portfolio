    ...
    <main className="">
      <div className=" min-w-full">
        <div className=" items-center md:w-1/2 ">
          ...
          <div className=" text-wrap text-sm w-80 p-3">
            <p>
              I excel ata crafting elegant websites and I'm proficient in
      ...
      <div className="flex gap-5 ">
        ...
        <Link href="/github" className="">
          <Button className=" border  rounded-full  border-accent text-accent hover:bg-accent-hover hover:text-primary ">
            <svg
              width="15"
              height="15"
              viewBox="0 0 15 15"
